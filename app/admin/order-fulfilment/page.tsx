...
const fulfilmentOrdersData: OrderItem[] = [
  {
    id: "#ORD0001",
...
const fulfilmentStats: StatItem[] = [
  {
    title: "Total Orders",
    value: "1,240",
    trendValue: "14.4%",
...
const fulfilmentTabs = ["All order (240)", "Completed", "Pending", "Canceled"];
...
export default function OrderFulfilmentPage() {
  return (
    <OrderListingView
      ...
      stats={fulfilmentStats}
      tabs={fulfilmentTabs}
      initialOrders={fulfilmentOrdersData}
      searchPlaceholder="Search order fulfillment, shipments..."
